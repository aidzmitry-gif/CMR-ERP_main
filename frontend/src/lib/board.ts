...
// «выпущен в ERP» и проставляется синхронно при выпуске счёта — деньги ещё НЕ дошли
 ...
 *  нейтральный «не оплачен». `null` — честный пропуск: ни оплаты, ни срока, ни выпуска в ERP. */
...
/**
 * Очередь «Счета под риском» (цикл 12): счёт выпущен (`posted` — выпущен в ERP), но НЕ
