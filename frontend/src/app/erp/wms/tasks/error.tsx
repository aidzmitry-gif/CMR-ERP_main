...
export default function TaskLoadError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  const router = useRouter();
  return <div role="alert" className="m-6 rounded-xl border border-line bg-surface p-6">
    <h1 className="text-lg font-semibold">Не удалось загрузить складские задания</h1>
