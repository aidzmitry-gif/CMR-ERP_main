...
export function pnlCsv(report: Report, applied: Applied) {
  const header = ["Организация", "С", "По", "Статус", "Доходы", "Расходы", "Финансовый результат", "Источник", "Дата", "Проводка", "Счёт", "Наименование", "Категория", "Сторона", "Сумма", "Валюта", "Аналитика"];
