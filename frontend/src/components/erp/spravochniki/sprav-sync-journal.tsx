      ...
      <div className="mx-auto max-w-5xl space-y-4">
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-muted">
                ...
                рождённая здесь, попадает в очередь. До подтверждённого исходящего адаптера
                операция остаётся с ошибкой и не считается выгруженной.
              </p>
            </div>
        ...
        <div className="rounded-2xl bg-surface p-5 shadow-card">
          ...
          <p className="mt-3 border-t border-line pt-3 text-[11px] text-faint">
            «в очереди» — ждёт выгрузки; «ошибка» — внешний адаптер не подтвердил запись или
            данные отклонены (ручной повтор после сверки). Реальная выгрузка требует отдельного
            проверенного исходящего адаптера.
          </p>
        </div>
