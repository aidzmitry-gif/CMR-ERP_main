...
type Preview = {
  ...
  digest: string;
  source_snapshot: Snapshot;
  lines: { account: string; title: string; side: string; amount: string }[];
...
export function AccountingBankImport({ org, accounts, policyId, date, onDate, onPosted }: {
  org: string;
  accounts: Account[];
  policyId?: number;
  date: string;
