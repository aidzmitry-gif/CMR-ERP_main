...
type CatalogAmendment = { document: string; date: string; effective_from: string; status: string; impact_on_chart?: string; full_text_verified?: boolean; checked_at?: string; evidence?: string; source_url?: string; source_kind?: string; review_scope?: string };
...
type Catalog = { version: string; source: string; verified_through: string; current_revision_reference?: string; current_normative_verified: boolean; verification_note?: string; normative_review?: NormativeReview; known_amendments?: CatalogAmendment[]; accounts: ChartRow[] };
