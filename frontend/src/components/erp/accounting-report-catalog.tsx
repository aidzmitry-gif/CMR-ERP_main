...
const items: Item[] = [
  ...
  { id: "debts", title: "Дебиторская и кредиторская задолженность", group: "goods", note: "Предварительная сводка по проведённым 60/62; сроки и просрочка пока не подтверждены", tab: "trade-settlements" },
