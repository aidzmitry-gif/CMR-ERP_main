...
type Source = { organization_id: number; receipt_id: number; entry_id: number; version: number; document: { invoice_reference: string; document_date: string; operation_date: string; supplier: string; contract: string; warehouse: string; explanation: string; items: { sku: string; lot: string; quantity: string; net_amount: string; vat_amount: string; vat_rate: string; vat_basis: string; order_id?: number | null }[] } };
