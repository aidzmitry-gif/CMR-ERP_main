...
export type AccountMovement = { entry_id: number; line_id: number; source: string; date: string; account: string; side: string; amount: string; currency: string; dimensions: Record<string, string> };
