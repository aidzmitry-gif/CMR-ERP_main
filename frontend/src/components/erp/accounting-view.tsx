...
export function AccountingView({ suggestedOrg, suggestedEntry }: { suggestedOrg?: string; suggestedEntry?: string }) {
  ...
  const [reportFavoriteState, setReportFavoriteState] = useState<ReportFavoriteState>({ ids: [], loaded: false });
