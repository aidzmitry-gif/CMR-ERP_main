...
| **Склад (WMS)** | **68** | 82/78/45 | bespoke | остаток — demo-зеркало 1С (не live pull); нет расчёта оборачиваемости и плана хранения/slotting ([roadmap](wms-turnover-storage-roadmap.md)); миграции вне checkout |
...
- Ветка `sales-2.0-redesign` · HEAD `56c869a fix(coord): снимок не врёт нулём при упавшем git — `_git` различает сбой и пустоту`
- Против `origin/sales-2.0-redesign`: впереди **7** · позади **7** · незакоммичено файлов **605**
