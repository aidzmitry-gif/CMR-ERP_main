...
- Ветка `sales-2.0-redesign` · HEAD `88dd7c9 fix(sales-board): фокус — «правее воронки» по позиции стадии, а не по карте вероятностей`
- Против `origin/sales-2.0-redesign`: впереди **5** · позади **5** · незакоммичено файлов **602**
