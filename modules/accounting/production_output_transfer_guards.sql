-- Finished-goods transfers retain an immutable source package.  New receipts
-- may carry one finished-goods debit and one credit per positive WIP analytic
-- group; old receipts without groups keep their two-line contract.
