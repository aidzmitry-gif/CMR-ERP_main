...
## Строгая схема `belarus-pilot-input-v5`
...
Манифесты v2–v4 намеренно не считаются полным пакетом перехода: в v2 не было
...
одной и той же системы. Даже v5 требует отдельного подтверждения происхождения
файлов и связи внешнего ID с книгой и УНП бухгалтером.
