...
## Строгая схема `belarus-pilot-input-v4`
...
Манифесты v2 и v3 намеренно не считаются полным пакетом перехода: в v2 не было
обязательного источника по зарплате и распределения ответственности, а v3
не связывал ID книги ERP с организацией в манифесте.
