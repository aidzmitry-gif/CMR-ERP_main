...
| Purchases, purchase orders, procurement plan and supplier primary receipts | [procurement navigation](../../frontend/src/components/erp/procurement-nav.tsx), [all-date source-document register](../../frontend/src/components/erp/procurement-receipt-drafts.tsx), [purchase receipt posting](../../frontend/src/components/erp/procurement-posted-receipt.tsx), [sales/procurement trace](SALES-PROCUREMENT-RESERVATION-TRACE.md) | Use real supplier documents and match stock, VAT and landed-cost results. The register contains procurement-owned primary receipt documents of the selected legal entity; legacy accounting entries without such a source still require explicit mapping. |
